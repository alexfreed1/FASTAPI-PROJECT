...
if(isset($_POST['username'])){
  ...
  if($r && $r->num_rows){ $_SESSION['admin']= $u; header('Location: dashboard.php'); exit; }
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .login-box h1 { color: #1e5a9f; margin-bottom: 10px; text-align: center; font-size: 20px; }
    .login-box h2 { color: #333; margin-bottom: 30px; text-align: center; font-size: 18px; }
...
<body>
  <div class="login-box">
    ...
    <h2>Admin Login</h2>
    <?php if(!empty($err)) echo '<div class="error">'.h($err).'</div>'; ?>
    <form method="post">
