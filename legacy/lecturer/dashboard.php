...
<body class="bg-gray-100 p-6">
  <div class="max-w-6xl mx-auto bg-white p-6 rounded-xl shadow-lg">
    ...
    <div class="text-center mb-6">
      <img src="../assets/THIKATTILOGO.jpg" alt="Logo" class="h-24 mx-auto mb-4">
      <h1 class="text-xl font-bold uppercase">THIKA TECHNICAL TRAINING INSTITUTE</h1>
      <h2 class="text-md font-semibold"><?php echo h($dept_name); ?> DEPARTMENT</h2>
      <h3 class="text-md font-semibold">UNIT ATTENDANCE REGISTER</h3>
      <p id="classTitle" class="text-gray-600">CLASS: <?php echo ($class_id ? h($class_list[array_search($class_id, array_column($class_list,'id'))]['name']) : ''); ?></p>
    </div>
